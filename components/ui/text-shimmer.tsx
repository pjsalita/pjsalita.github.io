  ...
  return (
    <MotionComponent
      className={cn(
        ...
        'text-transparent [--base-color:var(--primary)] [--base-gradient-color:var(--secondary-foreground)]',
        'text-transparent dark:[--base-color:var(--primary)] dark:[--base-gradient-color:var(--primary-foreground)]',
