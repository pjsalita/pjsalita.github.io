...
export default function Iphone({ viewHeight, width = 433, height = 882, src, videoSrc, ...props }: IphoneProps) {
  return (
    <svg width={width} height={viewHeight || height} viewBox={`0 0 ${width} ${height}`} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
      ...
      {videoSrc && (
        <foreignObject x="21.25" y="19.25" width="389.5" height="843.5">
          <video className="size-full overflow-hidden rounded-[55.75px] object-cover" src={videoSrc} autoPlay loop muted playsInline />
        </foreignObject>
      )}
      <path
